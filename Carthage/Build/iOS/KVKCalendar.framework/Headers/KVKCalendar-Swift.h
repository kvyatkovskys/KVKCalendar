...
// Generated by Apple Swift version 5.4 (swiftlang-1205.0.24.6 clang-1205.0.19.54)
#ifndef KVKCALENDAR_SWIFT_H
#define KVKCALENDAR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KVKCalendar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC11KVKCalendar12CalendarView")
...
- (void)editEventWithGesture:(UILongPressGestureRecognizer * _Nonnull)gesture;
